...
const sketch = ({ canvas }) => {
    //el canvas funciona como el cuarto cuadrante de un plano
    points = [
...
class Point {
    ...
    draw(context) {
        ...
        context.beginPath();
        context.arc(0, 0, 5, 0, Math.PI * 2); // x,y,radio, angulo inicial, angulo final
        context.fill();
        context.restore();
    }
